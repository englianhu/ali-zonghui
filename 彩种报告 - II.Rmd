...
pkgs <- c('plyr', 'dplyr', 'magrittr', 'stringr', 'knitr', 'kableExtra', 'lubridate', 'broom', 'purrr', 'tibble', 'DT')
...
mm000_d3 = lmer(Profit ~ Date * 
              ...
              (1 + Won * Cancelled | Bettor) * (Type / Date), smp2) %>% 
    extractAIC
write_rds(mm000_d3, paste0('data/mm000_d3.rds'))
...
mm001_d3 = lm(Profit ~ Date * 
               ...
               (1 + Won * Cancelled / Bettor) * (Type / Date), smp2) %>% 
    extractAIC
write_rds(mm001_d3, paste0('data/mm001_d4.rds'))
