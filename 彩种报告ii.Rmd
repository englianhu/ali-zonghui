...
author: "雷欧 <img src='figure/dashencaicai2.jpg' width='24'>"
...
mprf_list <- llply(num, function(i) {
    mprf = list(
        ...
        {p01 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p01'), degree = i, raw = TRUE) %>% 
        ...
        {p02 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p02'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p03 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p03'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p04 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p04'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p05 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p05'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p06 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p06'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p07 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p07'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p08 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p08'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p09 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p09'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p10 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p10'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p11 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p11'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p12 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p12'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p13 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p13'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p14 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p14'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p15 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p15'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p16 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p16'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p17 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p17'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p18 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p18'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p19 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p19'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p20 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p20'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p21 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p21'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
        ...
        {p22 = lm(Profit ~ 
          ...
          t %>% as_tibble %>% 
          dplyr::rename(df = V1, AIC = V2) %>% 
          mutate(.md = paste0('mprf_p22'), degree = i, raw = TRUE) %>% 
            dplyr::select(.md, degree, df, AIC); 
...
read_rds('data/mprf5.rds') %>% 
    ...
    kable_material()
```
`lm(Profit ~ poly(Bettor, degree = i, raw = TRUE) * ` `poly(Turnover, degree = i, raw = TRUE) * ` `poly(Won, degree = i, raw = TRUE) * ` `poly(Cancelled, degree = i, raw = TRUE) * ` `poly(Rebates, degree = i, raw = TRUE), smp2)`是最优模型，这儿我再添加内嵌模型。

```{r}
bs <- lm(Profit ~ poly(Bettor, degree = 1) * poly(Turnover, degree = 1) * poly(Won, degree = i, raw = TRUE) * poly(Cancelled, degree = i, raw = TRUE) * poly(Rebates, degree = 1), smp2)
